var cartaCaio={
  nome:'Oliver',
  imagem: "https://media.discordapp.net/attachments/825943694930739203/827670033072521236/54219e31-8b1a-4a6e-bc61-edd5685cf203.png?width=561&height=669",
  atributos:{
    ataque: 90,
    defesa: 65,
    magia: 20
...
var cartaBebel = {
  nome: 'Diana',
  imagem: "https://pbs.twimg.com/media/Ex44c7FWgAQ-7DJ?format=jpg&name=900x900",
  atributos:{
    ataque: 85,
    defesa: 60,
    magia: 90
...
var cartaCellbit = {
  nome: 'Carniçal',
  imagem: "https://i.pinimg.com/564x/9c/1f/f2/9c1ff26aac99642a399d3535e62143fc.jpg",
  atributos:{
    ataque: 99,
    defesa: 90,
    magia: 85
...
var cartaMaquina
var cartaJogador
var cartas = [cartaCaio, cartaBebel, cartaCellbit, cartaLol, cartaNaruto, cartaHarry, cartaBatman, cartaMarvel]
//            0           1           2          3         4            5            6           7     
var pontosJogador = 0
var pontosMaquina = 0
atualizaPlacar()
...
function jogar() {
    ...
    if (cartaJogador.atributos[atributoSelecionado] > cartaMaquina.atributos[atributoSelecionado]) {
        htmlResultado = '<p class="resultado-final">Venceu :D</p>'
      pontosJogador++
    } else if (cartaJogador.atributos[atributoSelecionado] < cartaMaquina.atributos[atributoSelecionado]) {
        htmlResultado = '<p class="resultado-final">Perdeu D:</p>'
      pontosMaquina++
    } else {
